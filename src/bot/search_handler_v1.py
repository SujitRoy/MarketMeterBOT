...
from src.core.config import INTRADAY_SYMBOLS, MARKET_OPEN_TIME, MARKET_CLOSE_TIME
...
async def cmd_search(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    """
    from src.bot.bot import _reply
...
async def on_search_select(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from src.bot.bot import _send_rich_chunks
